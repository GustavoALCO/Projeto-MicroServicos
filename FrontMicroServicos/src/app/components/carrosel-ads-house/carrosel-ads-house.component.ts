...
@Component({
  selector: 'app-carrosel-ads-house',
  standalone: true,
  imports: [CardHouseComponent, CommonModule],
  templateUrl: './carrosel-ads-house.component.html',
  styleUrl: './carrosel-ads-house.component.scss'
})
export class CarroselAdsHouseComponent {
    screenWidth!:number
